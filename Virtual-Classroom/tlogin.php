  ...
  <form method="post" action="login.php" class="form_container">
    ...
    <h1 class="text-center "style="color:white">Login</h1>
  	...
  	<div class="form-group">
  		...
  		<button type="submit" class="btn btn-success btn-block" name="login_usert">Login</button>

  	<p style="font-size: 20px; color:black">
  		Not yet a member? <a href="admin_teacher.php">Sign up</a></br><a href="start.php"><div class="text-center" style="font-size: 20px;">Home page</div></a>
  	</p>
  </form>
</div>
<div class="col-md-4 col-sm-4 col-xs-12"></div>
